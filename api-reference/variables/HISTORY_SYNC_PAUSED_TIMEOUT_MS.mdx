---
title: "HISTORY_SYNC_PAUSED_TIMEOUT_MS"
description: "120s timeout for history sync stall detection, same as WA Web's handleChunkProgress / restartPausedTimer (g = 120)"
---
