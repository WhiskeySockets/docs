---
title: "Migrate to Baileys v8"
description: "What to expect in Baileys v8: a class-based architecture, the upcoming whatsmeow integration, and a new authentication system that requires a one-time migration."
---
