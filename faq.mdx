---
title: "FAQ"
description: "Frequently asked questions about using Baileys, ranging from connection quirks and message delivery to LIDs and history sync."
---
...
Set `syncFullHistory: true` and use a desktop browser preset:
