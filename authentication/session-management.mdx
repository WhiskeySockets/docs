---
title: "Save and restore WhatsApp sessions"
description: "Persist your Baileys auth credentials to disk so you never need to re-scan the QR code. Covers useMultiFileAuthState and custom auth store patterns."
---
