---
title: "Baileys: WhatsApp Web API library for Node.js"
description: "Baileys connects to WhatsApp Web over a WebSocket without a browser. Build bots, automate chats, and handle real-time events in TypeScript."
---
