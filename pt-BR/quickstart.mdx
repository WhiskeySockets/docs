---
title: "Início rápido"
description: "Conecte, persista a sessão e envie a primeira mensagem em minutos."
---
...
<Steps>
  ...
  <Step title="Escute mensagens recebidas">
    ...
    Filtrar por `event.type === 'notify'` e `!m.key.fromMe` evita responder ao próprio bot e processar backfills de histórico como se fossem novas mensagens.
