...
description: "Todas as opções de `SocketConfig`: auth, browser, logger, cache, retries, timeouts."
---
...
Por padrão, o Baileys conecta com um perfil Chrome, o que limita quanto histórico o WhatsApp entrega. `syncFullHistory` já é `true` por padrão — o passo decisivo é trocar o preset de navegador para `Browsers.macOS('Desktop')`, que o WhatsApp trata como cliente desktop elegível para histórico estendido.
