---
title: "Extend Baileys with custom functionality"
description: "Register raw WebSocket callbacks, enable debug logging, and understand the binary node protocol WhatsApp uses to communicate with Baileys."
---
