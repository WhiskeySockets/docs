...
description: "Receive chats, contacts, and messages from before the link via the messaging-history.set event, and request more on demand with fetchMessageHistory."
---
