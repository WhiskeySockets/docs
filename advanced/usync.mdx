---
title: "USync protocol"
description: "Use the USync protocol (and MEX) to query WhatsApp for user metadata, LID/PN mappings, device lists, and other directory data."
---
