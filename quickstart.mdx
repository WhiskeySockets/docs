---
title: "Get started with Baileys"
description: "Build your first WhatsApp bot with Baileys in minutes. Learn to connect, handle events, save sessions, and send your first message step by step."
---
...
<Steps>
  ...
  <Step title="Create the socket">
    Create a socket by calling `makeWASocket` with your auth state. Setting `printQRInTerminal: true` renders the QR code directly in your terminal on first run.
