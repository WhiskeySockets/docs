---
title: "Implement a data store for Baileys"
description: "Baileys has no built-in persistence. Learn to use the in-memory store or build a custom data store for chats, messages, and contacts in your app."
---
