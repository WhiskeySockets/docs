---
title: "Baileys: WhatsApp Web API for TypeScript"
description: "Baileys is a WebSocket-based TypeScript library for the WhatsApp Web API. Connect without a browser, send messages, manage groups, and handle real-time events."
---
...
<Steps>
  <Step title="Install the library">
    Add Baileys to your Node.js project using your package manager of choice.
    ```bash
