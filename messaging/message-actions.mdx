---
title: "Edit, delete, and read WhatsApp messages"
description: "Delete messages for everyone, edit sent messages, mark messages as read, and update your typing or online presence using Baileys socket methods."
---
...
Listen for the `call` event to obtain the `callId` and `callFrom` values, then call `rejectCall` to decline the incoming call.
