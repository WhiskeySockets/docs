---
title: "Send WhatsApp messages with Baileys"
description: "Send text, links, contacts, locations, reactions, polls, and pin messages using sock.sendMessage. Full reference with working TypeScript examples."
---
