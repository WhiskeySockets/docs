---
title: "Create, configure, and manage WhatsApp groups in Baileys"
description: "Create and manage WhatsApp groups: add or remove participants, update settings, manage invites, approve join requests, and toggle ephemeral messages."
---
...
```typescript Change subject
await sock.groupUpdateSubject(jid, 'New Subject!')
```

```typescript Change description
